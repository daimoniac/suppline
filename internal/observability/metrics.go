	...
	metricsOnce.Do(func() {
		metricsInstance = &Metrics{
			...
			AttestationsCreated: promauto.NewCounterVec(
				prometheus.CounterOpts{
					Name: "daimoniac/suppline_attestations_created_total",
			...
			AttestationsFailed: promauto.NewCounterVec(
				prometheus.CounterOpts{
					Name: "daimoniac/suppline_attestations_failed_total",
			...
			ConditionalScanDecisionsTotal: promauto.NewCounterVec(
				prometheus.CounterOpts{
					Name: "daimoniac/suppline_conditional_scan_decisions_total",
			...
			ConditionalScanSkippedTotal: promauto.NewCounterVec(
				prometheus.CounterOpts{
					Name: "daimoniac/suppline_conditional_scan_skipped_total",
			...
			ConditionalScanEnqueuedTotal: promauto.NewCounterVec(
				prometheus.CounterOpts{
					Name: "daimoniac/suppline_conditional_scan_enqueued_total",
			...
			ConditionalScanSkipAgeSeconds: promauto.NewHistogramVec(
				prometheus.HistogramOpts{
					Name:    "daimoniac/suppline_conditional_scan_skip_age_seconds",
